...
async function main() {
  ...
  // Create super admin
  const admin = await prisma.dataRoomUser.upsert({
  ...
  const teaserUser = await prisma.dataRoomUser.upsert({
  ...
  const qualifiedUser = await prisma.dataRoomUser.upsert({
  ...
  const dealRoom1 = await prisma.dealRoom.upsert({
  ...
  const dealRoom2 = await prisma.dealRoom.upsert({
